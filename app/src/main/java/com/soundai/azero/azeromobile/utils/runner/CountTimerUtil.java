package com.soundai.azero.azeromobile.utils.runner;
...
public class CountTimerUtil {
     ...
     */
    public static <T extends TextView> void start(final T animationViewTv, final int repeatCount, AnimationState animationState) {
